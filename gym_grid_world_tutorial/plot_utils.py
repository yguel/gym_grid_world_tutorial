...
def plot_env(env,frame_title: Optional[str]=None, display_title=False):
...
def plot_env_coords(env,frame_title: Optional[str]=None, display_title=False):
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(6, 5))
...
def plot_val(env,values,minmax,frame_title: Optional[str]=None, display_title=False):
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(6, 5))
...
def plot_val_coords(env,values,minmax,frame_title: Optional[str]=None, display_title=False):
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(6, 5))
...
def plot_policy(env,policy,frame_title: Optional[str]=None, display_title=False):
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(6, 5))
...
def plot_policy_coords(env,policy,frame_title: Optional[str]=None, display_title=False):
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(6, 5))
